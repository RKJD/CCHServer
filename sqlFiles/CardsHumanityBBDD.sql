...
alter table CartaNegra add constraint fk_ba_caN foreign key(emailUsuario, nombreBaraja) references Baraja(emailUsuario, nombreBaraja);
alter table CartaBlanca add constraint fk_ba_caB foreign key(emailUsuario, nombreBaraja) references Baraja(emailUsuario, nombreBaraja);
