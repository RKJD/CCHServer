 ...
 */
@Entity
@Table(name = "cartanegra", catalog = "cardshumanity")
public class Cartanegra implements java.io.Serializable {
    ...
    public Cartanegra(CartaId id, Baraja baraja) {
        this.id = id;
        this.baraja = baraja;
    }

    public Cartanegra(CartaId id, Baraja baraja, Integer numeroEspacios, String texto) {
        this.id = id;
        this.baraja = baraja;
