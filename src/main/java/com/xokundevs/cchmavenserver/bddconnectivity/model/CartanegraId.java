...
/**
 * CartanegraId generated by hbm2java
 */
public class CartanegraId  implements java.io.Serializable {
    ...
    public CartanegraId(int idCarta, String emailUsuario, String nombreBaraja) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof CartanegraId) ) return false;
		 CartanegraId castOther = ( CartanegraId ) other; 
